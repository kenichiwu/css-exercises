...
* **All odd numbered elements** 1,3,5: a light red/pink background, and a list of fonts containing `Verdana` and `DejaVu Sans` with `sans-serif` as a fallback
* **The second element** 2: blue text and a font size of 36px
* **The third element** 3: in addition to the styles for all odd numbered elements, add a font size of 24px
* **The fourth element** 4: a light green background, a font size of 24px, and bold
